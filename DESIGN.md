# Design system — appsprint_studio
...
- **Dark mode:** Light mode only — avoid hardcoded colors that will not adapt if dark mode is added later.
- **Customization:** Global `ThemeData` lives in `lib/src/theme/theme.dart` — avoid one-off `ThemeData` overrides in feature widgets.

- **Seed color:** `#2563EB` (used to derive `ColorScheme` via `ColorScheme.fromSeed` where applicable).
...
Primary family: **InterVariable**

- **InterVariable** — 2 file(s) configured in `pubspec.yaml` (app-wide `fontFamily` when primary)
- **Inter** — 10 file(s) configured in `pubspec.yaml`
- **Inter BlackItalic** — 1 file(s) configured in `pubspec.yaml`
- **Inter BoldItalic** — 1 file(s) configured in `pubspec.yaml`
- **Inter ExtraBoldItalic** — 1 file(s) configured in `pubspec.yaml`
- **Inter ExtraLightItalic** — 1 file(s) configured in `pubspec.yaml`
- **Inter LightItalic** — 1 file(s) configured in `pubspec.yaml`
- **Inter MediumItalic** — 1 file(s) configured in `pubspec.yaml`
- **Inter SemiBoldItalic** — 1 file(s) configured in `pubspec.yaml`
- **Inter ThinItalic** — 1 file(s) configured in `pubspec.yaml`
- **InterDisplay** — 10 file(s) configured in `pubspec.yaml`
- **InterDisplay BlackItalic** — 1 file(s) configured in `pubspec.yaml`
- **InterDisplay BoldItalic** — 1 file(s) configured in `pubspec.yaml`
- **InterDisplay ExtraBoldItalic** — 1 file(s) configured in `pubspec.yaml`
- **InterDisplay ExtraLightItalic** — 1 file(s) configured in `pubspec.yaml`
- **InterDisplay LightItalic** — 1 file(s) configured in `pubspec.yaml`
- **InterDisplay MediumItalic** — 1 file(s) configured in `pubspec.yaml`
- **InterDisplay SemiBoldItalic** — 1 file(s) configured in `pubspec.yaml`
- **InterDisplay ThinItalic** — 1 file(s) configured in `pubspec.yaml`
...
Import tokens via `package:appsprint_studio/src/theme/theme_constants.dart`.
